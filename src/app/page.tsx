...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-secondary/30">
      <Header />
      <main className="flex-1 w-full max-w-7xl mx-auto p-4 md:p-6 grid gap-8 grid-cols-1 lg:grid-cols-2 lg:gap-12 items-start">
        ...
        <div className="flex flex-col gap-6">
          <Card className="rounded-xl shadow-lg border-border/50 flex-1 flex flex-col">
            ...
            <CardContent className="p-6 text-left flex-1 min-h-[500px]">
              {isLoading && (
